...
function About(props) {
    return (
        <div>
            ...
            <p className="bio">
                Patrick's first career was in door to door sales, which led to opportunities in retail and managing tent events.   After getting his fill in sales, Patrick realized he wanted to use his communication skills to work in a team environment. Soon after, he enrolled in the University of Richmond's Coding Bootcamp.
            </p>
            <p className="bio">
